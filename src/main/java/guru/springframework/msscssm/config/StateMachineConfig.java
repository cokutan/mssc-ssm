...
import guru.springframework.msscssm.services.actions.AuthAction;
import guru.springframework.msscssm.services.actions.PreAuthAction;
...
public class StateMachineConfig extends StateMachineConfigurerAdapter<PaymentState, PaymentEvent> {
    ...
    @Autowired
    private PreAuthAction preAuthAction;
    @Autowired
